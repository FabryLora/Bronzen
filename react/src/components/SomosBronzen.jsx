...
export default function SomosBronzen() {
    ...
    return (
        <div
            ...
            className="h-[680px] max-sm:h-auto max-sm:min-h-[600px] w-full bg-no-repeat bg-cover bg-top bg-center max-sm:text-center"
        >
            <div className="w-[1200px] max-sm:w-full max-sm:px-4 mx-auto h-full">
                <div className="flex flex-row max-sm:flex-col justify-between h-full py-20 max-sm:py-12">
                    <div className="flex flex-col w-full max-sm:w-full text-white gap-12 max-sm:gap-6 max-sm:order-1">
                    ...
                    <div className="flex justify-center items-center w-full max-sm:w-full max-sm:py-8 max-sm:order-2">
                        <img
